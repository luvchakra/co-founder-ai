 ...
 * dismiss pattern (outside click / Escape) as the sidebar and account menus. History is
 * ephemeral -- kept in this component's state only, never persisted -- since nothing in
 * the current stories needs it to survive a reload.
 */
            ...
            <div className="flex flex-1 flex-col gap-3 overflow-y-auto p-4">
              {messages.length === 0 ? (
                <p className="text-sm text-muted-foreground">
                  Ask about GTM strategy, your ICP, prospects, or how to use co-founder-ai.
                </p>
              ) : (
                messages.map((m, i) => (
                  <div
